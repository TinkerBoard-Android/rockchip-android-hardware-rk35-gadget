...
#define LOG_TAG "librkusb-MonitorFfs"

#include "include/rkusb/MonitorFfs.h"
...
void MonitorFfs::setGadgetName(const std::string name) {
    mGadgetName = name;
}
...
void *MonitorFfs::startMonitorFd(void *param) {
    ...
    if (monitorFfs->mGadgetName == "") {
        ALOGE("Please set gadget name via setGadgetName(const char *name)");
        return NULL;
    }
